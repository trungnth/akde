function [pdf,X1,X2,X3]=akde(X,grid,gam)
...
%                default provided only for 3-dimensional data;
...
%         X1,X2,X3 - grid only for 3 dimensional data
%
%
%%  Reference:
...
if (nargin<2)|isempty(grid) % failing to provide grid
    warning('Assuming data is 3 dimensional. For higher dimensions, provide a grid as in example.')
